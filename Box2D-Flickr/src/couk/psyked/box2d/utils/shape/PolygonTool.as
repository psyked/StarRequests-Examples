package couk.psyked.box2d.utils.shape
{
    ...
    public class PolygonTool
    {
        ...
        public static function earClip( p_vertices:Array ):Array
        {
            // Touchmypixel's triangulator needs an array of points.
            var points:Array = new Array();
            for each ( var v:Point in p_vertices )
            {
                //points.push( new Point( v.x, v.y ));
                points.push( v);
            }
            var triangles:Array = Triangulator.triangulatePolygon( points );
            var polys:Array = Triangulator.polygonizeTriangles( triangles );
